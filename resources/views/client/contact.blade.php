...
@section('content')
    <div class="container">
        {{-- Liên hệ --}}
        <section class="bg-light py-3 py-md-5 mt-4 mb-3">
            <div class="container">
                <div class="row gy-3 gy-md-4 gy-lg-0 align-items-md-center">
                    <div class="col-12 col-lg-6">
                        <div class="row justify-content-xl-center">
                            <div class="col-12 col-xl-11">
                                <h2 class="h1 mb-3">Liên hệ với chúng tôi</h2>
                                <p class="lead fs-5 text-secondary mb-5">Nếu bạn có bất kỳ câu hỏi nào hoặc cần hỗ trợ thêm,
                                    xin vui lòng liên hệ với chúng tôi để được tư vấn tận tình.</p>
                                <div class="d-flex mb-5">
                                    ...
                                    <div>
                                        ...
                                        <address class="mb-0 text-secondary">Trịnh Văn Bô - Nam Từ Liêm, Hà Nội</address>
                                    </div>
                                </div>
                                <div class="row mb-5">
                                ...
                                <div class="d-flex">
                                    ...
                                    <div>
                                        ...
                                        <div class="d-flex mb-1">
                                            <p class="text-secondary fw-bold mb-0 me-5">Thứ 2 - Thứ 6</p>
                                            <p class="text-secondary mb-0">9am - 5pm</p>
                                        </div>
                                        <div class="d-flex">
                                            <p class="text-secondary fw-bold mb-0 me-5">Thứ 7 - Chủ Nhật</p>
